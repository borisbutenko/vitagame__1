...
!function (a, b) {
    ...
    var q = "3.1.0 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector,-deprecated", r = function (a, b) {
...
/*!
 * Generated using the Bootstrap Customizer (http://bootstrap-3.ru/customize.php?id=6d8cd1cc62960f16fe69416f4c48c2a1)
 * Config saved to config.json and https://gist.github.com/6d8cd1cc62960f16fe69416f4c48c2a1
 */
    ...
    var Paginator = function() {
        return {
            ...
            _createNavigationWrapper: function() {
                this.nav = $(
                    '<nav class="pagination__nav" aria-label="Page navigation">' +
                    '<ul class="pagination" ' + this.options.navigationClass + '></ul>' +
                    '</nav>'
                );
                // Change for bootstrap, down is original
                //     $('<nav>', {
            ...
            _createNavigationButton: function(text, options) {
                this.nav
                    ...
                    .append(
                        $('<li>').append(
                            $('<a>', $.extend(options, { href: '#', text: text }))
                        )
                    )
            },
